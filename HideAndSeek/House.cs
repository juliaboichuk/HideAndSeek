namespace HideAndSeek
{
    public static class House
    {
        ...
        {
            var locationsByName = locations.Where(l => l.Name == name).ToList();
            return locationsByName.Count > 0 ? locationsByName.First() : Entry;
        }
        ...
        public static void ClearHidingPlaces()
        {
            ...
            {
                if (location is LocationWithHidingPlace hidingLocation)
                    hidingLocation.CheckHidingPlace();
            }
        }
    }
}
